...
<div class="maincontainer">
    ...
    <div class="radio-options radio-group">
        <input name="scopus-radiobutton" type="radio" value="Yes" id="scopus-yes-option" />
        <label for="scopus-yes-option">Yes</label>
        <input name="scopus-radiobutton" type="radio" value="No" id="scopus-no-option" />
...
<div class="row">
    ...
    <div class="radio-options radio-group">
        <input name="wos-radiobutton" type="radio" value="Yes" id="wos-yes-option" />
        <label for="wos-yes-option">Yes</label>
        <input name="wos-radiobutton" type="radio" value="No" id="wos-no-option" />
        <label for="wos-no-option">No</label>
    </div>
    <label for="emp_id" style="margin-left:100px">Peer Reviewed:</label>
    <div class="radio-options radio-group">
        <input name="peer-review-radiobutton" type="radio" value="Yes" id="peer-review-yes-option" />
        <label for="peer-review-yes-option">Yes</label>
        <input name="peer-review-radiobutton" type="radio" value="No" id="peer-review-no-option" />
        <label for="peer-review-no-option">No</label>
    </div>
</div>
