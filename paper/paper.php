...
.inputbox {
 ...
 .row1 {
    ...
    <title> Papers in Conference</title>
...
<div class="maincontainer">
    <div class="hero">
          <h1>Papers in Conference Proceeding Published by Faculty/ Scientist</h1>
        <hr>
    </div>
    <form action="" method="post">
    <div class="prsnlinfo">
        <fieldset class="fieldsetsectn">
            ...
            <div class="row">
                <label for="faculty">Name of Other Author/s:</label>
                    <div class="inputbox">
    ...
    <div class="bookinfo">
        <fieldset class="fieldsetsectn">
            ...
            <legend class ="section">Paper Information</legend>
            <div class="row">
            ...
            <div class="row">
                 <label for="booktitle">Name of Conference:</label>
                    <div class="inputbox">
                        <input type="text" name="booktitle" required="required">
                        <span>Conference</span>
                    </div>
            
                 <label for="booktitle" class="row1">Conference Paper or any thing which you would like to mentioned :</label>
                    <div class="inputbox">
                        <input type="text" name="booktitle" required="required">
    ...
    <div class="publicationdate inputbox row1">
        <input type="date" name="publicationdate" required="required" style="width:150px;">
			 ...
			 <div class="row">
                ...
                <label for="Edition" class="row1">Volume/Edition:</label>
                    <div class="inputbox">
			  ...
			  <div class="row">
               <label for="co-author">Page</label>
                ...
                <label for="booktitle" class="row1">Impact Factor:</label>
                    <div class="inputbox">
                        <input type="text" name="booktitle" required="required">
              ...
              <legend class="section">Other Information</legend>
                   <div class="row">
                    ...
                    <div class="row">
					  ...
					  <label for="emp_id" class="row1"  style="margin-left:100px">Peer Reviewed:</label>
                       <div class="radio-options">
                       <input name="radiobutton" type="radio" value="Yes" id="yes-option" />
                        <label for="yes-option">Yes</label>
                       <input name="radiobutton" type="radio" value="No" id="no-option" />
            ...
            <div class="row">
                <label for="faculty">ISSN:</label>
                    <div class="inputbox">
					 ...
					 <label for="emp_id" class="row1">ISBN:</label>
                    <div class="inputbox">
                        <input type="text" name="co-author" required="required" min="1" >
                        <span>ISBN</span>
                    </div>
             ...
             <div class="row">
                <label for="faculty">Name of Publisher:</label>
					...
					<label for="emp_id" class="row1">Institutional affiliations:</label>
                    <div class="inputbox">
                        <input type="text" name="co-author" required="required" min="1" >
			 ...
			 <div class="row">
                <label for="faculty">Correponding Author:</label>
                    <div class="inputbox">
					 ...
					 <label for="emp_id" class="row1">Citation Index:</label>
                    <div class="inputbox">
                        <input type="text" name="co-author" required="required" min="1" >
